      ...
      <div className="max-w-[1240px] mx-auto px-28 py-20 flex flex-col justify-center items-center">
        <div>
          ...
          <h1 className="py-3 text-gray-500 text-2xl font-medium tracking-wider">
            Open Source{" "}<b className='text-[#3B2EC9] '>Flatfile.com</b>{" "}Alternative
            <br />
            <span className="text-blue-500 normal-case">An Open source platform for exchanging data between businesses.</span>
          </h1>
        </div>
        ...
        <div className='w-full flex flex-col gap-1 mt-4 rounded-md shadow-md bg-gray-50 text-left py-2 px-4'>
          ...
          <p className='mt-1 text-gray-500 text-center'>This demo walks a user through importing an CSV into a pre-defined template.</p>
          ...
          <div className='p-4'>
            ...
            <div className='w-full flex flex-col gap-1 shadow-md rounded-md text-left py-2 px-4 bg-white'>
              ...
              <div className='flex justify-between text-center items-center'>
                ...
                <Link href="https://drive.google.com/uc?id=1wzo1yVtYv9UyZUCNOZ2Fq4QITFDXKHVw&export=download">
                  <button className='bg-[#5EB4EA] w-[160px] h-[40px]  text-sm text-white p-2 rounded-md'>Download CSV</button>
                </Link>
              </div>
            </div>
            ...
            <div className='w-full flex flex-col gap-1 mt-2 shadow-md rounded-md text-left py-2 px-4 bg-white'>
              ...
              <div className='flex justify-between text-center items-center'>
                <p className='text-left text-md text-gray-700'>Go To Imports Section and check the Status. <br /> CSV Data is imported successfully to your MongoDB.</p>
                <Link href='/imports'>
                  <button className='bg-[#5EB4EA] w-[160px] h-[40px]  text-sm text-white p-2 rounded-md'>Validate Import Status</button>
                </Link>
              </div>
            </div>
        ...
        <div className='w-full flex flex-col gap-1 shadow-2xl rounded-md text-left py-2 px-4 mt-4 bg-white'>
          ...
          <div className='p-4 flex justify-between'>
            <Link href="https://drive.google.com/uc?id=1N1UMgvM4VO64lOnpkzSPft5Wt-SJokHG&export=download">
              <button className='bg-[#5EB4EA] text-sm text-white p-2 rounded-md'>CSV With 50k Rows</button>
            </Link>
            <Link href="https://drive.google.com/uc?id=1pcmwsRo0XqTUAcjMGgYH2tzW8xAl13nd&export=download">
              <button className='bg-[#5EB4EA] text-sm text-white p-2 rounded-md'>CSV with 1 million records</button>
            </Link>
            <Link href="https://drive.google.com/uc?id=1yP2awQiwHE-gCEScZWTwP5K6XGokvAZ_&export=download">
              <button className='bg-[#5EB4EA] text-sm text-white p-2 rounded-md'>CSV for custom mail validation</button>
            </Link>
            <Link href="https://drive.google.com/uc?id=1QbM5GmIGVg_ZJCdcE2etWX55qKj2UU7L&export=download">
              <button className='bg-[#5EB4EA] text-sm text-white p-2 rounded-md'>CSV for custom integer validation</button>
            </Link>
          </div>
