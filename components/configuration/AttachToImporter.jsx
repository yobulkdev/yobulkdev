  ...
  return (
    <div className="flex p-4 align-middle items-center">
      <div className="flex flex-col w-5/12">
        <h2 className="text-lg font-bold text-gray-500">Attach A Template <span className='text-red-400'>*</span></h2>
        <p className="text-sm text-gray-400">Attach a template to a importer.</p>
      </div>
